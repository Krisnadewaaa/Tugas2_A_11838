...
model_path = 'D:\Semester 5\Pembelajaran Mesin dan Pembelajaran Mendalam\Tugas_A_11838'
...
if RestingECG == "LVH":
    input_restcg_LVH = 1
    input_restcg_NORMAL = 0
    input_restcg_ST = 0
elif RestingECG == "Normal":
    input_restcg_LVH = 0
    input_restcg_NORMAL = 1
    input_restcg_ST = 0
elif RestingECG == "ST":
    input_restcg_LVH = 0
    input_restcg_NORMAL = 0
...
input_data = [[input_sex_F, input_sex_M, input_cpain_ASY,
              ...
              input_restcg_LVH, input_restcg_NORMAL, input_restcg_ST,
